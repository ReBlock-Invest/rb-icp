...
# treasury = xu377-2nxx5-haly6-tybji-sa2cu-m2kh6-dv7a3-atqlf-2va7s-ptnyc-aae

# deposit USDC from lender
dfx canister call dummy_usdc approve "(principal \"c5kvi-uuaaa-aaaaa-qaaia-cai\", 1000_000_000_000)"
dfx canister call pool deposit "(1000_000_000_000)"
...
dfx canister call dummy_usdc approve "(principal \"aax3a-h4aaa-aaaaa-qaahq-cai\", 100_000_000_000)"
dfx canister call pool repay_interest "(100_000_000_000)"
dfx canister call dummy_usdc approve "(principal \"aax3a-h4aaa-aaaaa-qaahq-cai\", 1_498_500_000_000)"
dfx canister call pool repay_principal "(1_498_500_000_000)"
dfx canister call dummy_usdc balanceOf 'principal "qwnep-krhyp-dhcck-wkqco-etadf-wijbq-c6iat-bqr3a-tbzsp-hbywq-eae"'

dfx canister call dummy_usdc balanceOf 'principal "bw4dl-smaaa-aaaaa-qaacq-cai"'

# withdraw USDC from lender
dfx canister call pool withdraw "(499500000000)"
...
dfx canister call factory back_loan '(record { info = record {apr = "5.5%"; title = "Retail Government Bonds (ORI)"; issuer_picture = "https://upload.wikimedia.org/wikipedia/commons/thumb/7/73/Logo_kementerian_keuangan_republik_indonesia.png/120px-Logo_kementerian_keuangan_republik_indonesia.png"; smart_contract_url = "https://a4gq6-oaaaa-aaaab-qaa4q-cai.raw.icp0.io/?id="; total_loan_amount = "250,000.00"; payment_frequency = "MONTHLY"; description = "ORI is a retail investment instrument in the form of government bonds that can be traded on the secondary market. ORI also has a fixed coupon in the form of monthly yields paid to the investor who purchases it"; maturity_date = 1746164164; loan_term = "12 MONTHS"; issuer_description = "Indonesia Ministry of Finance"; secured_by = "Indonesia Ministry of Finance"; fundrise_end_time = 1715797568888638286; credit_rating = "A"; origination_date = 1715797568888638286}; token_args = record {name = "ReBlock Token Pool"; symbol = "RB01"; decimals = 8; fee = 0; max_supply = 1_000_000_000_000_000_000; initial_balances = vec {}; min_burn_amount = 0;}; borrowers = vec { principal "qwnep-krhyp-dhcck-wkqco-etadf-wijbq-c6iat-bqr3a-tbzsp-hbywq-eae"; principal "fcqo5-se6eb-qgbif-pbgvf-fux7c-zceqw-gyhbo-55w26-2a6io-oiy6o-4ae"; }; asset = principal "o24ms-4yaaa-aaaal-ad7wq-cai"; fee = record { treasury = principal "xu377-2nxx5-haly6-tybji-sa2cu-m2kh6-dv7a3-atqlf-2va7s-ptnyc-aae"; fee_basis_point = 10000; fee = 10;  }; })' --network ic

dfx canister call pool withdraw "(1_000_000_000)"

dfx deploy pool --argument '(record { info = record {apr = "5.5%"; title = "Retail Government Bonds (ORI)"; issuer_picture = "https://upload.wikimedia.org/wikipedia/commons/thumb/7/73/Logo_kementerian_keuangan_republik_indonesia.png/120px-Logo_kementerian_keuangan_republik_indonesia.png"; smart_contract_url = "https://a4gq6-oaaaa-aaaab-qaa4q-cai.raw.icp0.io/?id="; total_loan_amount = "250,000.00"; payment_frequency = "MONTHLY"; description = "ORI is a retail investment instrument in the form of government bonds that can be traded on the secondary market. ORI also has a fixed coupon in the form of monthly yields paid to the investor who purchases it"; maturity_date = 1746164164; loan_term = "12 MONTHS"; issuer_description = "Indonesia Ministry of Finance"; secured_by = "Indonesia Ministry of Finance"; fundrise_end_time = 1715797568888638286; credit_rating = "A"; origination_date = 1715797568888638286}; token_args = record {name = "ReBlock Token Pool"; symbol = "RB01"; decimals = 8; fee = 0; max_supply = 1_000_000_000_000_000_000; initial_balances = vec {}; min_burn_amount = 0;}; borrowers = vec { principal "qwnep-krhyp-dhcck-wkqco-etadf-wijbq-c6iat-bqr3a-tbzsp-hbywq-eae"; principal "fcqo5-se6eb-qgbif-pbgvf-fux7c-zceqw-gyhbo-55w26-2a6io-oiy6o-4ae"; }; asset = principal "be2us-64aaa-aaaaa-qaabq-cai"; fee = record { treasury = principal "xu377-2nxx5-haly6-tybji-sa2cu-m2kh6-dv7a3-atqlf-2va7s-ptnyc-aae"; fee_basis_point = 10000; fee = 10;  }; })'  

dfx canister call factory remove_pool '(principal "hsv4y-6yaaa-aaaal-ajedq-cai")' --network ic

dfx ledger top-up --icp 1 rugve-6qaaa-aaaal-ajafq-cai --network ic