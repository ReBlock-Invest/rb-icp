...
import { idlFactory } from './dummy_usdc.did.js';
export { idlFactory } from './dummy_usdc.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_DUMMY_USDC;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./dummy_usdc.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the dummy_usdc canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./dummy_usdc.did.js")._SERVICE>}
 */
export const dummy_usdc = createActor(canisterId);
