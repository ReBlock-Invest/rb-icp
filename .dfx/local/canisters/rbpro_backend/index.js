...
import { idlFactory } from './rbpro_backend.did.js';
export { idlFactory } from './rbpro_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_RBPRO_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./rbpro_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the rbpro_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./rbpro_backend.did.js")._SERVICE>}
 */
export const rbpro_backend = createActor(canisterId);
