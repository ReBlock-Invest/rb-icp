...
export interface Token {
  ...
  'getBorrowerAddress' : ActorMethod<[], Principal>,
  'getCurrencyAddress' : ActorMethod<[], Principal>,
  ...
  'setBorrower' : ActorMethod<[Principal], undefined>,
  'setCurrency' : ActorMethod<[Principal], undefined>,
