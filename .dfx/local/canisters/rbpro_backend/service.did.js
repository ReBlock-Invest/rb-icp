export const idlFactory = ({ IDL }) => {
  ...
  const Token = IDL.Service({
    ...
    'getBorrowerAddress' : IDL.Func([], [IDL.Principal], []),
    'getCurrencyAddress' : IDL.Func([], [IDL.Principal], []),
    ...
    'setBorrower' : IDL.Func([IDL.Principal], [], ['oneway']),
    'setCurrency' : IDL.Func([IDL.Principal], [], ['oneway']),
